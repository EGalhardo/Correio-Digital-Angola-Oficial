...
const STATIC_TRANSLATE_MAP: Record<string, Record<LanguageCode, string>> = {
  ...
  "Arquivadas": { pt: "Arquivadas", um: "Vilundulwi", ki: "Kiambot", kk: "Mamo", ch: "Chichin", ng: "Lelev", kw: "Oshila", nh: "Elau", fi: "Mbote" },
  ...
  "Arquivada": { pt: "Arquivada", um: "Yalundululwa", ki: "Kiambot", kk: "Mamo", ch: "Chichin", ng: "Lelev", kw: "Oshila", nh: "Elau", fi: "Mbote" },
