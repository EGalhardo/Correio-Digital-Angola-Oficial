          ...
          {step === 2 && (
            ...
            >
              ...
              <div className="text-center mt-1.5 animate-fadeIn">
                <h1 className="text-[#0f172a] text-xl md:text-2xl font-black tracking-tight uppercase leading-none">SUBMISSÃO OFICIAL<br />DE IDENTIDADE</h1>
              </div>
              ...
              <div className="space-y-4 text-left max-w-2xl mx-auto">
                ...
                <div className="space-y-1.5">
                  <label className="text-[10.5px] font-black text-slate-800 uppercase tracking-widest flex items-center gap-1.5 mb-1 bg-transparent">
                    <FileText size={13} className="text-[#2563eb]" /> Nº DO BILHETE DE IDENTIDADE (Nº B.I.)
                  </label>
                    ...
                    <label className={`group relative border-2 border-dashed rounded-[20px] p-3.5 text-center flex flex-col items-center justify-center min-h-[128px] cursor-pointer transition-all duration-300 select-none ${
                      ...
                      {isUploadingFrente ? (
                        <div className="flex flex-col items-center gap-1.5">
                          ...
                          <span className="text-[10.5px] font-black text-[#2563eb] uppercase tracking-widest">A ler OCR...</span>
                        </div>
                      ) : frenteSuccess ? (
                        <div className="flex flex-col items-center w-full">
                          ...
                          <span className="text-[9px] font-black text-emerald-700 mt-1 uppercase tracking-tight">Frente Carregada</span>
                        </div>
                      ) : (
                        <div className="flex flex-col items-center gap-1.5">
                          ...
                          <div className="space-y-0.5">
                            <span className="text-[11px] font-black text-slate-800 uppercase tracking-widest block font-sans">CARREGAR FRENTE</span>
                    ...
                    <label className={`group relative border-2 border-dashed rounded-[20px] p-3.5 text-center flex flex-col items-center justify-center min-h-[128px] cursor-pointer transition-all duration-300 select-none ${
                      ...
                      {isUploadingVerso ? (
                        ...
                        <div className="flex flex-col items-center w-full">
                          ...
                          <span className="text-[9px] font-black text-emerald-700 mt-1 uppercase tracking-tight">Verso Carregado</span>
                        </div>
                      ) : (
                        <div className="flex flex-col items-center gap-1.5">
                          <div className="w-10.5 h-10.5 bg-white border border-blue-50 rounded-full flex items-center justify-center text-[#2563eb] shadow-sm">
          ...
          {step === 3 && (
            ...
            >
              ...
              <div className="text-center">
                <h1 className="text-[#0f172a] text-2xl font-extrabold tracking-tight mb-1 leading-tight">Assinatura de Biometria Facial</h1>
              </div>
          ...
          {step === 'success' && (
            ...
            >
              ...
              <div className="bg-blue-50 border border-blue-100/60 rounded-2xl p-4.5 text-left flex gap-3 items-center">
                <span className="text-[12.5px] font-black text-blue-800 select-none font-sans">B.I. de Acesso:</span>
