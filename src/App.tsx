                  ...
                  <div className="space-y-3 pt-0.5">
                    ...
                    <div className="pt-1.5 flex flex-col gap-2.5">
                      ...
                      <div className="relative flex items-center py-0.5">
                        ...
                        <span className="flex-shrink mx-3 text-slate-400 text-[9px] font-black uppercase tracking-[0.2em] bg-white px-2.5 select-none">{t("Ou")}</span>
                        <div className="flex-grow border-t border-slate-100"></div>
                      </div>

                      {/* Credentials sub text below separator */}
                      <div className="space-y-1.5">
                        <p className="text-[9px] text-slate-400 font-extrabold text-center uppercase tracking-wider">
